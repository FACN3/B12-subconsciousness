...
var _user$something$Main$renderCard = function (card) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$src(card.img),
					_1: {ctor: '[]'}
				},
				{ctor: '[]'}),
			_1: {ctor: '[]'}
...
var _user$something$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				A2(_elm_lang$core$List$map, _user$something$Main$renderCard, model.cards)),
			_1: {ctor: '[]'}
		});
};
var _user$something$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$something$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$something$Main$Card = F3(
	function (a, b, c) {
		return {id: a, img: b, matchFound: c};
	});
var _user$something$Main$Model = function (a) {
	return {cards: a};
};
var _user$something$Main$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	_user$something$Main$Model(
		{
			ctor: '::',
			_0: {id: 'finn', img: 'https://avatars3.githubusercontent.com/u/14337958?v=4', matchFound: false},
			_1: {
				ctor: '::',
				_0: {id: 'aisha', img: 'https://avatars3.githubusercontent.com/u/22300773?v=4', matchFound: false},
				_1: {
					ctor: '::',
					_0: {id: 'suha', img: 'https://avatars1.githubusercontent.com/u/24496866?v=4', matchFound: false},
					_1: {ctor: '[]'}
				}
			}
		}),
	{ctor: '[]'});
var _user$something$Main$main = _elm_lang$html$Html$program(
	{init: _user$something$Main$init, view: _user$something$Main$view, update: _user$something$Main$update, subscriptions: _user$something$Main$subscriptions})();
var _user$something$Main$NoOp = {ctor: 'NoOp'};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$something$Main$main !== 'undefined') {
    _user$something$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
